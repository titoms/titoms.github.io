...
export type ServiceContent = Omit<ServicePageData, 'slug' | 'stripeLink'>;

export const servicesContentEn: Record<string, ServiceContent> = {
  'ai-web-development-newsletter': {
    ...
    included: [
      { title: "Monthly AI web dev briefing", description: "A curated summary of what actually matters in AI and web development this month." },
      { title: "Tool updates", description: "Honest takes on new AI coding tools — what changed, what is worth trying, what is hype." },
      { title: "Coding workflow ideas", description: "Practical patterns for integrating AI into React, Node.js and TypeScript projects." },
      { title: "Practical prompts", description: "Tested prompts for coding, architecture and product thinking." },
      { title: "Worth testing / ignore", description: "A direct opinion on what to spend time on and what to skip this month." },
      { title: "Opinionated recommendations", description: "Clear recommendations with reasoning, not summaries." },
    ],
    pricing: [
    ...
    faqs: [
      { question: "What is this newsletter about?", answer: "A monthly practical update about generative AI, coding tools, web development workflows, AI agents and product opportunities." },
      { question: "Who is it for?", answer: "Developers, founders, freelancers, trainers and small technical teams." },
      { question: "Is it beginner-friendly?", answer: "Yes. The tone is clear and practical, with enough detail for developers but without useless jargon." },
      { question: "Will you include sources?", answer: "Yes. Issues include source links and practical interpretation, not just summaries." },
      { question: "Can I use it for my team?", answer: "Yes. The team plan is made for internal knowledge sharing." },
      { question: "Can I cancel anytime?", answer: "Yes. There is no commitment. You can cancel any time from your account." },
    ],
  },
  'web-project-coaching': {
    ...
    included: [
      { title: "Project diagnosis", description: "A clear read on your codebase, architecture and the actual source of the problem." },
      { title: "Technical explanation", description: "Plain-language walkthrough of what is happening and why." },
      { title: "Action plan", description: "Written next steps tailored to your project and skill level." },
      { title: "Architecture advice", description: "Practical guidance on structure, patterns and trade-offs." },
      { title: "Debugging help", description: "Live hands-on work through your specific blocker." },
      { title: "Next steps", description: "A clear path forward so the session has a defined outcome." },
    ],
    pricing: [
    ...
    faqs: [
      { question: "Do I need to be technical?", answer: "No. The session can be adapted to non-technical founders, beginners or developers." },
      { question: "Can you help with existing code?", answer: "Yes, if you can share the repo, screenshots, errors or clear context." },
      { question: "Can you help with AI-generated code?", answer: "Yes. I can help you understand, debug and clean code generated by ChatGPT, Claude, Cursor or Copilot." },
      { question: "Is this development or consulting?", answer: "It can include both guidance and live technical help, but it is not unlimited development work." },
      { question: "What should I prepare?", answer: "A description of your project, your goal, your blocker and any useful links or files." },
      { question: "Can this lead to development work?", answer: "Yes. If the scope is clear, you can move from coaching to development days or a custom MVP project." },
    ],
  },
  'full-stack-development-day': {
    ...
    included: [
      { title: "React and Next.js work", description: "Pages, layouts, dashboards and interactive UI components." },
      { title: "Node.js APIs", description: "REST endpoints, Express routes, data modeling and third-party integrations." },
      { title: "Database work", description: "PostgreSQL schema, queries, migrations and data cleanup." },
      { title: "Auth flows", description: "Session management, JWT, OAuth2 or provider-based authentication." },
      { title: "Bug fixing", description: "Diagnosis and resolution of production bugs with reproduction steps." },
      { title: "Delivery notes", description: "A written summary of what was done, decisions made and what to do next." },
    ],
    pricing: [
    ...
    processSteps: [
      { title: "Send the task", description: "Describe the task, what done looks like, and share the repo and any relevant context." },
      { title: "Validate the scope", description: "I confirm the task is realistic for the session length and clarify any blockers before starting." },
      { title: "Focused development session", description: "I work on your project in a dedicated block with no interruptions." },
      { title: "Receive delivery notes", description: "A written summary of what was done, what changed and what to do next." },
      { title: "Optional next session", description: "If the scope needs more time, we schedule a follow-up with a refined task." },
    ],
    faqs: [
      { question: "Can you build a full app in one day?", answer: "No. A full app requires a custom project. This service is for focused development work on a specific task." },
      { question: "What technologies do you work with?", answer: "React, Next.js, TypeScript, Node.js, Express, PostgreSQL, Docker and modern web tools." },
      { question: "Can you work on an existing codebase?", answer: "Yes, if the repository and setup instructions are clear." },
      { question: "Can you fix bugs?", answer: "Yes, if you provide enough context, reproduction steps and access." },
      { question: "Can you integrate AI APIs?", answer: "Yes. I can help with OpenAI API, AI-assisted workflows and simple AI-powered features." },
      { question: "Will you explain what you changed?", answer: "Yes. Delivery notes summarize what was done and what to do next." },
    ],
  },
  'mvp-bootstrapping-workshop': {
    ...
    included: [
      { title: "MVP scope", description: "A defined list of what to build and what to defer for the first version." },
      { title: "Feature priorities", description: "A ranked feature list based on impact, risk and build effort." },
      { title: "Tech stack recommendation", description: "A practical stack matched to your team, timeline and product needs." },
      { title: "Development roadmap", description: "A phased plan with milestones and realistic delivery estimates." },
      { title: "Budget estimation", description: "A rough cost range based on scope, complexity and timeline." },
      { title: "Risk map", description: "Known risks, assumptions and how to reduce uncertainty before building." },
    ],
    pricing: [
    ...
    faqs: [
      { question: "Do I need a technical background?", answer: "No. This workshop is designed to make technical choices understandable." },
      { question: "Do I need an existing project?", answer: "No. You can come with only an idea or a rough concept." },
      { question: "Will you build the MVP during the workshop?", answer: "No. The workshop creates the plan, roadmap and scope. Development is a separate service." },
      { question: "What is the difference between 1 day and 5 days?", answer: "The 1-day workshop gives clarity and a roadmap. The 5-day sprint goes deeper into specs, architecture, user flows and delivery planning." },
      { question: "Can this workshop lead to a full MVP build?", answer: "Yes. If the scope is realistic, it can become a custom development project." },
      { question: "Can you include AI features in the roadmap?", answer: "Yes. AI features can be evaluated based on usefulness, complexity and cost." },
    ],
  },
  'mvp-development': {
    ...
    included: [
      { title: "Product clarification", description: "Discovery sessions to align on scope, priorities and success criteria." },
      { title: "Technical architecture", description: "System design, data models, API contracts and infrastructure plan." },
      { title: "Frontend", description: "React or Next.js UI built to your product structure and design direction." },
      { title: "Backend", description: "Node.js API with Express, authentication, business logic and integrations." },
      { title: "Database", description: "PostgreSQL or Supabase schema design, migrations and query optimization." },
      { title: "Deployment and handover", description: "Production deployment to Cloudflare Pages, Vercel or your preferred host, plus full codebase documentation." },
    ],
    ...
    processSteps: [
      { title: "Discovery", description: "I'll map the product idea, target users, must-have features, constraints and risks with you." },
      { title: "Scope and proposal", description: "I write a clear scope document with milestones, timeline and a fixed-price proposal." },
      { title: "Build sprint", description: "Development happens in focused sprints with regular check-ins and progress updates." },
      { title: "Review", description: "You test the working product and provide feedback before the final delivery." },
      { title: "Deployment and handover", description: "The product is deployed to production and handed over with full documentation." },
    ],
    faqs: [
      { question: "How much does an MVP cost?", answer: "MVP development starts at 4,500 EUR. Most projects range between 6,000 EUR and 15,000 EUR depending on scope." },
      { question: "How long does it take?", answer: "It depends on the scope. A small MVP may take a few weeks. A more complex MVP needs a staged roadmap." },
      { question: "Can you help define the scope first?", answer: "Yes. The AI Clarity Bootstrap Workshop is recommended before development if the idea is still unclear." },
      { question: "Can you include AI features?", answer: "Yes, if they are useful and realistic for the first version." },
      { question: "Do you handle deployment?", answer: "Yes. Deployment and handover are included." },
      { question: "Can you work with an existing codebase?", answer: "Yes, after review. Existing projects may require an audit first." },
      { question: "Do you provide design?", answer: "I can create clean product UI structures, but advanced branding or custom visual identity may require a dedicated designer." },
      { question: "What happens after launch?", answer: "You can book development days, support, improvements or a new sprint." },
    ],
  },
};
