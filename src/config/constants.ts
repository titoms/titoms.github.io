...
export const heroStats: BuildStat[] = [
  ...
  },
  {
    value: "5",
    label: "offer paths",
    description: "Newsletter, coaching, development days, MVP workshops and custom builds.",
  },
  {
    value: "React + Node",
    label: "core stack",
    description: "Practical TypeScript delivery for web apps, dashboards and AI workflows.",
  },
];
...
export const serviceOffers: ServiceOffer[] = [
  {
    ...
    description:
      "A practical monthly briefing on AI coding tools, developer workflows, prompts, agents and MVP opportunities.",
    price: "9 EUR",
    priceUnit: "/mo",
    badge: "Newsletter",
  },
  {
    ...
    description:
      "One-on-one technical guidance for blocked projects, messy codebases, architecture choices and AI-generated code.",
    price: "90 EUR",
    priceUnit: "/hour",
    badge: "Coaching",
    featured: true,
  },
  {
    ...
    description:
      "Focused development time for scoped bugs, features, dashboards, APIs, refactors and deployment fixes.",
    price: "600 EUR",
    priceUnit: "/day",
    badge: "Delivery",
  },
  {
    ...
    description:
      "A practical workshop to clarify product scope, technical choices, roadmap, budget and build sequence.",
    price: "650 EUR",
    priceUnit: "/day",
    badge: "Workshop",
  },
  {
    ...
    description:
      "Custom React, Node.js and TypeScript MVP development from product scope to deployment and handover.",
    price: "from 4,500 EUR",
    badge: "MVP",
  },
];
...
export const faqs: FAQ[] = [
  {
    ...
    answer:
      "No. Coaching and MVP workshops are designed to make technical choices understandable for non-technical founders as well as developers.",
  },
  {
    question: "Can you work on an existing codebase?",
    answer:
      "Yes, if the repository, setup instructions, blockers and success criteria are clear enough to scope the session.",
  },
  {
    question: "Is a development day enough to build a full app?",
    answer:
      "No. Development days are for focused tasks. Full products should start with an MVP workshop or a custom quote.",
  },
  {
    question: "Can you help with AI-generated code?",
    answer:
      "Yes. I can help you understand, debug, clean and structure code generated by ChatGPT, Claude, Cursor or Copilot.",
  },
  {
    question: "How much does a custom MVP cost?",
    answer:
      "Custom MVP development starts at 4,500 EUR. Most projects range from 6,000 EUR to 15,000 EUR depending on scope.",
  },
];
...
// Stripe Payment Links — set from Stripe dashboard > Payment Links (public URLs, safe to commit)
